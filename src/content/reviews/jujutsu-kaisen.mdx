...
<InsertThought>
  Manga, and especially shonen manga, have deep problems with female characters.
  Usually there is at least one female character introduced as a love interest
  and portrayed very poorly with deeply sexualised physical characteristics and
  secondary to the main character, generally a boy, and following them around as
  a love interest. The manga Bleach is a particularly egregious example of this
  with the character Orihime Inoue relegated to being a damsel in distress for
  most of the runtime. Jujutsu Kaisen was initially lauded for having active
  women combatants and fighters within its roster. And spoiler alert, it
...
<SpoilerText>
  The worst issues of the ridiculous power scaling and the empty, convoluted
  fights begin to rear their ugly heads immediately after the Shibuya Arc when
  the Culling Games Arc begins. A country wide "Culling Game" with the actual
  arena set in the city of Tokyo is initiated, orchestrated by the Big Bad Boss.
  Numerous sorcerers and curses are brought together to let loose their worst
  natures and kill others to gain points. This is where the main cast decide to
  participate and face off against these numerous enemies but all of it feels
  boring and the pacing grinds to a halt. The reasons for participating in these
  games become mired in drawn out matches with more and more head-spinning
  powers and plots and a laundry list of throwaway uninteresting tertiary
  characters.
</SpoilerText>

<SpoilerText>
  As if this wasn't enough, the end of this arc leads to the final battle where
  almost every single surviving member of the "good guys" all gang up on one
  extremely powerful enemy... and this is one of the most stretched out finales
  of any manga I've read or any anime I've watched. Characters come in, have a
  flashback to explain to the reader what they're supposed to do in the fights,
  do something inconsequential and then are taken out off-screen leaving space
  for the next character to come in and this repeats ad nauseam. The flashbacks
  not being enough, we need play-by-plays from characters and the narrator to
  explain what the hell is going on and why the fight does not resolve in any
  timely manner. It reminds one of a child bashing action figures together,
  making rules up on the fly and utterly unconcerned about making any sense and
  instead having fun with their imagination. But this isn't a child we're
  talking about. This is a "writer" of one of the most popular manga being paid
  to write this drivel. This big fight that takes up almost 45 chapters is
  suddenly ended in the span of two chapters. If that description sounds abrupt,
  then... yeah.
</SpoilerText>
